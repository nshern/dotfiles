...
hi(0, 'ColorColumn', { bg = palette.teal[100] })
hi(0, 'Type', { link = Normal })
hi(0, 'Operator', { link = Normal })
hi(0, 'Comment', { fg = palette.green[60], bold = true })
hi(0, 'Conceal', { fg = palette.teal[100] })
...
hi(0, 'DiagnosticError', { fg = palette.red[60] })
hi(0, 'DiagnosticHint', { fg = palette.blue[50] })
hi(0, 'DiagnosticInfo', { fg = palette.teal[50] })
hi(0, 'DiagnosticOk', { fg = palette.green[50] })
hi(0, 'DiagnosticUnderlineError', { sp = palette.red[60], underline = 1 })
hi(0, 'DiagnosticUnderlineHint', { sp = palette.blue[50], underline = 1 })
hi(0, 'DiagnosticUnderlineInfo', { sp = palette.teal[50], underline = 1 })
hi(0, 'DiagnosticUnderlineOk', { sp = palette.green[50], underline = 1 })
...
hi(0, 'SpellBad', { sp = palette.red[60], undercurl = 1 })
...
hi(0, 'StatusLine', { bg = palette.teal[100], fg = palette.white })
hi(0, 'String', { link = Normal })
hi(0, 'Title', { fg = palette.teal[40], bold = true })
