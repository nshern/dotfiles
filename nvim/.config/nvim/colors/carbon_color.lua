...
vim.g.colors_name = "carbon_color"
...
hi(0, "Keyword", { fg = palette.purple[40] })
hi(0, "ColorColumn", { bg = palette.gray[100] })
hi(0, "Comment", { fg = palette.blue[60], bold = true })
...
hi(0, "Function", { fg = palette.magenta[40] })
hi(0, "FzfLuaBufNr", { link = Normal })
hi(0, "FzfLuaHeaderBind", { link = Normal })
hi(0, "FzfLuaHeaderText", { link = Normal })
hi(0, "FzfLuaPathLineNr", { link = Normal })
hi(0, "FzfLuaTabTitle", { link = Normal })
hi(0, "FzfPathColNr", { link = Normal })
...
hi(0, "String", { fg = palette.blue[40] })
hi(0, "Title", { link = Normal })
hi(0, "Type", { fg = palette.orange[40] })
