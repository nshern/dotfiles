...
hi(0, "CmpItemAbbrDeprecatedDefault", { fg = "#788a8a" })
...
hi(0, "CmpItemKindDefault", { fg = "#bb6d9b" })
...
hi(0, "LeapLabelPrimary", { bold = true, ctermfg = 186, fg = "#ebcd91", nocombine = true })
hi(0, "LeapLabelSecondary", { bold = true, ctermfg = 252, fg = "#d0d0d0", nocombine = true })
...
hi(0, "PmenuSel", { bg = "#d0d0d0", blend = 0, ctermbg = 252, ctermfg = 238, fg = "#324747" })
