...
if vim.o.background == "dark" then
	...
	hi(0, "@markup.heading.5.markdown", { bg = NONE, fg = NvimLightCyan, bold = true })
	hi(0, "@markup.heading.6.markdown", { bg = NONE, fg = NvimLightGreen, bold = true })
...
if vim.o.background == "light" then
	...
	hi(0, "@markup.heading.5.markdown", { bg = NONE, fg = NvimDarkCyan, bold = true })
	hi(0, "@markup.heading.6.markdown", { bg = NONE, fg = NvimDarkGreen, bold = true })
