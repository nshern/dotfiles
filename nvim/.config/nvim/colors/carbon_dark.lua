...
hi(0, "markdownH1Delimiter", { fg = palette.blue[40] })
hi(0, "markdownH2Delimiter", { fg = palette.magenta[40] })
hi(0, "markdownH3Delimiter", { fg = palette.green[40] })
hi(0, "markdownH4Delimiter", { fg = palette.orange[40] })
hi(0, "markdownH5Delimiter", { fg = palette.purple[40] })
...
hi(0, "CursorLine", { bg = palette.gray[90] })
